...
function App() {
  ...
  const educationEvents: TimelineEvent[] = [
    ...
    {
      date: '2012 – 2015',
      title: en ? 'Upper Secondary — IT & Media' : 'Videregående — IT og medieproduksjon',
  ...
  return (
    <>
      ...
      {/* Header */}
      <Header name="Sigurd Olsen" title={en ? 'Senior Frontend Engineer' : 'Senior Frontend-utvikler'}>
        <SocialLink href="https://github.com" icon="github-icon" label="GitHub" />
        <SocialLink href="https://linkedin.com" icon="social-icon" label="LinkedIn" />
      </Header>

      {/* ── Projects ── */}
      <Section
        title={tr.sections.projects}
        description={en ? 'A selection of things I have built.' : 'Et utvalg av ting jeg har laget.'}
      >
        <div className="grid gap-4 text-left md:grid-cols-2">
          ...
          <Card href="https://github.com">
            <h3 className="mb-1 font-semibold text-[var(--text-h)]">WeatherDash</h3>
            <p className="mb-3 text-sm text-[var(--text)]">
              {en
          ...
          <Card href="https://github.com">
            <h3 className="mb-1 font-semibold text-[var(--text-h)]">BudgetTracker</h3>
            <p className="mb-3 text-sm text-[var(--text)]">
              {en
          ...
          <Card href="https://github.com">
            <h3 className="mb-1 font-semibold text-[var(--text-h)]">DevLog CLI</h3>
            <p className="mb-3 text-sm text-[var(--text)]">
              {en
      ...
      <Section
        ...
        description={en ? 'Technologies and tools I work with regularly.' : 'Teknologier og verktøy jeg jobber med jevnlig.'}
      >
        <div className="flex flex-wrap gap-2 text-left">
          {[
            'JavaScript', 'TypeScript', 'React', 'Next.js', 'Vue',
            'Node.js', 'Express', 'PostgreSQL', 'MongoDB', 'Redis',
            'Tailwind CSS', 'Figma', 'Docker', 'Git', 'CI/CD',
            'REST', 'GraphQL', 'AWS', 'Vercel', 'Storybook',
          ].map((skill) => (
      ...
      <Section
        ...
        description={en ? 'What I do when I\'m not coding.' : 'Hva jeg gjør når jeg ikke koder.'}
      >
      ...
      <Section title={tr.sections.awards}>
        <div className="grid gap-4 text-left md:grid-cols-2">
          <Card>
            ...
            <h3 className="mb-1 font-semibold text-[var(--text-h)]">
              {en ? 'AWS Certified Solutions Architect' : 'AWS Certified Solutions Architect'}
            </h3>
            <p className="text-sm text-[var(--text)]">
              {en ? 'Amazon Web Services — Associate level.' : 'Amazon Web Services — Associate-nivå.'}
            </p>
          </Card>
          <Card>
          ...
          <Card>
            ...
            <h3 className="mb-1 font-semibold text-[var(--text-h)]">
              {en ? 'Google UX Design Certificate' : 'Google UX Design-sertifikat'}
            </h3>
            <p className="text-sm text-[var(--text)]">
              {en
          ...
          <Card>
            ...
            <h3 className="mb-1 font-semibold text-[var(--text-h)]">
              {en ? 'NDC Oslo Hackathon — 1st Place' : 'NDC Oslo Hackathon — 1. plass'}
            </h3>
            <p className="text-sm text-[var(--text)]">
              {en
